...
**Day**: 7
**Phase**: Phase 1b - Mold Generation
**Duration**: 2-3 hours
**Cost**: $3-5 (50K tokens)
...
Define C++ interface for NURBS mold generation using OpenCASCADE.

---

## Context

**From v5.0 Spec (§2.2)**: Lossless until fabrication
...
**Dependencies**:
- SubDEvaluator (for exact sampling)
- OpenCASCADE 7.x (NURBS operations)
...
**Used by**: Agents 47-50

**File Placement**:
```
cpp_core/
├── geometry/
│   └── nurbs_generator.h  ← YOU CREATE THIS
```
