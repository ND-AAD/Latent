# Agent 55: Mold Generation Workflow Orchestration
...
Orchestrate complete workflow: Region analysis → Constraint validation → NURBS generation → Export to Rhino.

---

## Deliverables

**File**: `app/workflow/mold_generator.py`
...
```python
# app/workflow/mold_generator.py
...
- [ ] NURBS fitting with quality check
- [ ] Draft transformation applied
- [ ] Export data serialized
